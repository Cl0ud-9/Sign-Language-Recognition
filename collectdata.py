...
while True:
    ...
    count = {
             ...
             'glad': len(os.listdir(directory+"\\glad")),
             'is': len(os.listdir(directory+"\\is")),
             'my': len(os.listdir(directory+"\\my")),
             'name': len(os.listdir(directory+"\\name")),
             'to': len(os.listdir(directory+"\\to")),
             'what': len(os.listdir(directory+"\\what")),
             'your': len(os.listdir(directory+"\\your")),             
             }
    ...
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(directory+'name/'+str(count['name'])+'.png',frame)
    if interrupt & 0xFF == ord('2'):
        cv2.imwrite(directory+'hi/'+str(count['hi'])+'.png',frame)
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+'is/'+str(count['is'])+'.png',frame)
    if interrupt & 0xFF == ord('4'):
        cv2.imwrite(directory+'my/'+str(count['my'])+'.png',frame)
    if interrupt & 0xFF == ord('5'):
        cv2.imwrite(directory+'glad/'+str(count['glad'])+'.png',frame)
    if interrupt & 0xFF == ord('6'):
        cv2.imwrite(directory+'to/'+str(count['to'])+'.png',frame)
    if interrupt & 0xFF == ord('7'):
        cv2.imwrite(directory+'what/'+str(count['what'])+'.png',frame)
    if interrupt & 0xFF == ord('8'):
        cv2.imwrite(directory+'your/'+str(count['your'])+'.png',frame)
